...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    labal_real = torch.ones(logits_real.shape).type(dtype).squeeze()
    label_fake = torch.zeros(logits_fake.shape).type(dtype).squeeze()
    loss_real = bce_loss(logits_real, labal_real)
