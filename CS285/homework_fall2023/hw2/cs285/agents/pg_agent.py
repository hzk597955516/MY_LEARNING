...
class PGAgent(nn.Module):
    ...
    def update(
        ...
        info: dict  = self.actor.update(obs=obs,
                                        actions=actions,
        ...
        if self.critic is not None:
            ...
            for _ in range(self.baseline_gradient_steps):
                critic_info: dict = self.critic.update(obs=obs,
                                                       q_values=q_values)
    ...
    def _discounted_return(self, rewards: Sequence[float]) -> Sequence[float]:
        ...
        involve t)!
        """
        disc_return = sum([rewards[t] * self.gamma**t for t in range(len(rewards))])
        disc_return = [disc_return] * len(rewards)
        return disc_return
    ...
    def _discounted_reward_to_go(self, rewards: Sequence[float]) -> Sequence[float]:
        ...
        disc_return = [rewards[t:] @ discounts[:T-t] for t in range(T)]
        return disc_return
