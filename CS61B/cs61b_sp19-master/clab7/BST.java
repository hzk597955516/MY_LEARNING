...
public class BST<Key extends Comparable<Key>> {
    ...
    public int allpath_help(Node i, int k){
        if (i != null){
            return k + allpath_help(i.right, k+1) + allpath_help(i.left, k+1);
        }
        else {
            return 0;
        }
    ...
    public int allpath(){
        return allpath_help(root, 0);
    }

    public double AverageDepth(){
        return (double)allpath() / size();
    }
    ...
    public static void main(String[] arg){
        ...
        bst.add(3);
        bst.add(4);
        System.out.println(bst.AverageDepth());
    }
}
