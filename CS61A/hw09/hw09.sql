...
CREATE TABLE sentences AS
  SELECT a.first || ' and ' || a.second || ' are ' || b.size || ' siblings' from siblings as a, size_of_dogs as b, size_of_dogs as c where a.first = b.name and a.second = c.name and b.size = c.size;