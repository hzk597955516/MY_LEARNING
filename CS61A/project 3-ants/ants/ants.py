...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect, QueenAnt) and insect.True_queen == True and insect.armor > 0:
                return None
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        if self.place.ant == None:
            return False
        elif self.place.ant != None and self.place.ant.blocks_path == False:
            return False
        else:
            return True
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        def find(place, min_range, max_range):
            if place == hive or max_range < 0:
                return None
            else:
                if min_range >= self.min_range:
                    if len(place.bees) > 0:
                        return random_or_none(place.bees)
                return find(place.entrance, min_range+1, max_range-1)
        return find(self.place, 0, self.max_range)
        # END Problem 3 and 4
...
# END Problem 13
    ...
    def __init__(self):
        ...
        if QueenAnt.there_is == False:
            QueenAnt.there_is = True
    ...
    def action(self, colony):
        ...
        if self.place != None and self.True_queen == True:
            ScubaThrower.action(self, colony)
            place = self.place.exit
            while place != None:
                if place.ant != None:
                    if place.ant.container == True and place.ant.ant != None:
                        if place.ant.ant not in self.antlist:
                            self.antlist.append(place.ant.ant)
                            place.ant.ant.damage *= 2
                    elif place.ant not in self.antlist:
                        self.antlist.append(place.ant)
                        place.ant.damage *= 2
                place = place.exit
        # END Problem 13
